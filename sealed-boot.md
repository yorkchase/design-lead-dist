...
**VERSION 1.3 · 2026-07-18** — latest always at
...
---
*Version 1.3 · 2026-07-18 · Source of truth: `design-lead/` in the design-kb repo (github.com/yorkchase/design-kb). Form modeled on HeroUI Design Taste + Untitled UI AGENT.md; substance from the portable core only. §G grows through PROCESS §6 harvest — numbers stay stable; amendments append.*
